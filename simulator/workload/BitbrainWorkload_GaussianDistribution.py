...
class BWGD(Workload):
    def __init__(self, meanNumContainers, sigmaNumContainers):
        ...
        if not path.exists(dataset_path):
            ...
            zf.close()
            for f in listdir(dataset_path + 'rnd/2013-9/'): shutil.move(dataset_path + 'rnd/2013-9/' + f,
                                                                        dataset_path + 'rnd/')
    ...
    def generateNewContainers(self, interval):
        ...
        for i in range(max(1, int(gauss(self.mean, self.sigma)))):
            ...
            RAMModel = RMBitbrain((df['Memory usage [KB]'] / 1000).to_list(),
            ...
            DiskModel = DMBitbrain(disk_size, (df['Disk read throughput [KB/s]'] / 1000).to_list(),
